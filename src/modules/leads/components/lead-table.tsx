...
import { leadPriorityLabels, leadServiceTypeLabels, type Lead } from "../types";
  ...
  return (
    <div className="overflow-x-auto rounded-lg border border-border bg-card">
      <div className="min-w-[1120px]">
        <div className="grid grid-cols-[1.2fr_1fr_0.9fr_0.8fr_1.2fr_1fr_0.8fr_44px] border-b border-border bg-muted/70 px-4 py-3 text-xs font-semibold uppercase text-muted-foreground">
        ...
        {leads.map((lead) => (
          <div
            className="grid grid-cols-[1.2fr_1fr_0.9fr_0.8fr_1.2fr_1fr_0.8fr_44px] items-center border-b border-border px-4 py-4 text-sm last:border-0"
            key={lead.id}
          >
            <div>
